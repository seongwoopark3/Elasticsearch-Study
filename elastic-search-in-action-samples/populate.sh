...
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/1?refresh" -d'{
  "name": "Denver Clojure",
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/2?refresh" -d'{
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/3?refresh" -d'{
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/4?refresh" -d'{
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/5?refresh" -d'{
...
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/100?routing=1&refresh" -d'{
  "host": ["Lee", "Troy"],
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/101?routing=1&refresh" -d'{
  "host": "Sean",
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/102?routing=1&refresh" -d'{
  "host": "Daniel",
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/103?routing=1&refresh" -d'{
  "host": "Lee",
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/104?routing=1&refresh" -d'{
  "host": "Lee",
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/105?routing=1&refresh" -d'{
  "host": "Lee",
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/106?routing=1&refresh" -d'{
  "host": "Mik",
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/107?routing=1&refresh" -d'{
  "host": "Mik",
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/108?routing=1&refresh" -d'{
  "host": "Elyse",
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/109?routing=1&refresh" -d'{
  "host": "Andy",
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/110?routing=1&refresh" -d'{
  "host": "Andy",
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/111?routing=1&refresh" -d'{
  "host": "Andy",
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/112?routing=1&refresh" -d'{
  "host": "Dave Nolan",
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/113?routing=1&refresh" -d'{
  "host": "Dave",
...
echo
curl -H "Content-Type: application/json" -s -XPOST "$ADDRESS/get-together/_doc/114?routing=1&refresh" -d'{
  "host": "Yann",
